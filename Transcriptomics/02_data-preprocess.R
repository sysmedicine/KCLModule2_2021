...
proteinCodingGenes = getBM(attributes=c("ensembl_transcript_id", "ensembl_gene_id","external_gene_name","description"), filters='biotype', values=c('protein_coding'), mart=ensembl)
save(proteinCodingGenes,file=saveFile)
...
# UMAP object
u.tpm.pre_1000 = umap( mat.tpm.pre_1000 )

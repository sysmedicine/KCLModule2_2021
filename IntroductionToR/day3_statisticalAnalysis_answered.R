...
#Exercises 1#
#############
df2 <- read.table("IntroductionToR/Data/DATA_SET_REFERENCE_4_A.csv",sep=",",header=TRUE,row.names = 1)
...
df3 <- read.table("IntroductionToR/Data/DATA_SET_REFERENCE_2.csv",

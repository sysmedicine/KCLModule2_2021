...
#We are going to learn about the arithmatic and logical operations,
#syntax, data type, and ultimately making our own functions
...
#defining variables
a <- 5 # the a variable is equal to 5
b <- 20
c <- 17
...
paste('My weight is',g,'kg', 'and my height is something') #check the difference between paste and paste0

paste(e,j,paste('My codename is',f),sep=', ')
...
for(haha in c('Muhammad', 'Arif','Saeed', 'Adil')){
  print_name(haha)
}
